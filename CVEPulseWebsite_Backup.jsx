    ...
    <div className="bg-slate-900 py-20">
      <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="bg-slate-800 rounded-lg p-8 border border-slate-700">
            ...
            <form className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 bg-slate-700 border border-slate-600 rounded-lg text-white focus:outline-none focus:border-cyan-500">
              ...
              <button 
                type="submit"
                className="w-full py-3 bg-cyan-600 hover:bg-cyan-700 text-white rounded-lg font-semibold transition-all"
              >
                Send Message
              </button>
            </form>
        ...
        <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-lg p-8 text-center">
          ...
          <button className="px-8 py-3 bg-white text-cyan-600 rounded-lg font-semibold hover:bg-slate-100 transition-all">
            Schedule a Call
          </button>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-slate-400 text-sm">
              <li className="hover:text-cyan-400 cursor-pointer">Vulnerability Management</li>
              <li className="hover:text-cyan-400 cursor-pointer">Threat Intelligence</li>
              <li className="hover:text-cyan-400 cursor-pointer">Application Security</li>
              <li className="hover:text-cyan-400 cursor-pointer">SOC Monitoring</li>
            </ul>
          </div>
          <div>
